...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['ACY9', 'ATL2', 'AUS2', 'BOS3', 'BWI5', 'CLE2', 'CLT4', 'CLT6', 'DCA1', 'DENA', 'FTW5', 'FTW2', 'HGR5', 'HGR6', 'HGR2', 'HIA1', 'MCI9', 'MCO1', 'MDT4', 'MSP1', 'OKC2', 'ONT5', 'ORH3', 'PHL6', 'PNE5', 'QZZ1', 'SAT1', 'SBD6', 'SDF8', 'TUL2', 'TUL5'],
        urgentPrefixes: [],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
