...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['ACY9', 'AKC1', 'ATL2', 'ATLB', 'AUS5', 'AZA5', 'BWI5', 'IGQ9', 'DEN3', 'CLT6', 'MDT4', 'MDT5', 'MSP7', 'PNE9', 'RDU1', 'RFD4', 'STL8', 'TLH2', 'TUS5', 'XMD2'],
        urgentPrefixes: [],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
        ...
        notification.innerHTML = `
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 15px; font-weight: 600; margin-bottom: 4px;">${siteCode} - 1P THRESHOLD SITE- IF TRAILER ISSUE IS: TIRE, ELECTRICAL(LIGHTS, 7-WAY), MUDFLAP, OR ANYTHING MINOR WHEN ASSIGNING, MAKE WORK ORDER URGENT. LEAVE COMMENT: GUIDED BY LEADERSHIP TO ASSIGN URGENT IF ISSUE IS A MINOR REPAIR.</div>
