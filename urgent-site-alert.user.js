...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['ONT5', 'HGR6', 'MSP8', 'ACY9', 'XMD2', 'TYS1', 'JFK8', 'HIA1', 'ORD5', 'SWF1', 'BWI5', 'TEB9', 'OMA2', 'DEN5', 'ATL2', 'FSD1', 'STL8', 'HLO3', 'BDU5', 'QZZ1', 'MDT4', 'HSE1', 'ROC5', 'ILG1', 'XLA3', 'ORH3', 'MCI5', 'ROC1', 'TUS2', 'ABE8', 'XLX7', 'PDX8', 'AUS2', 'SWF2', 'MGE9', 'DET3'],
        urgentPrefixes: [],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
