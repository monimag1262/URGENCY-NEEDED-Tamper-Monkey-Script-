...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['ACY9', 'AKC1', 'APC2', 'ATL2', 'BOI2', 'BWI4', 'BWI5', 'DCA1', 'GEU3', 'HGR5', 'HGR6', 'HIA1', 'HLO3', 'HMW1', 'HOU9', 'HSE1', 'JFK8', 'MCI5', 'MDT4', 'MDW5', 'MDW7', 'ONT5', 'ORD2', 'ORD5', 'ORH3', 'RDU1', 'SAT3', 'TEB9', 'TUS5', 'XCE1', 'XMD2'],
        urgentPrefixes: [],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
