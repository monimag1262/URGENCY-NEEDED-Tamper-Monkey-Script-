...
(function() {
    ...
    // ============================================
    const CONFIG = {
        // Exact site code matches for Site is over 1P damaged threshold! - Comment: Assigning urgent due to 1P Threshold, guided by Leadership. urgency
        urgentSites: [
            'ACY9', 'AUS3', 'AUS5', 'BDL4', 'FSD1', 'HGR6', 'HLO3', 'MCI9', 'MKC6', 'MSP8', 'OKC2', 'ONTB', 'ORF4', 'PSP3', 'SAT2', 'SBN1', 'TLH2', 'TUS5', 'TYS1'
        ],
        ...
        modal.innerHTML = `
            <div style="margin-bottom: 20px;">
                ...
                <p style="
                    ...
                    font-size: 18px;
                    font-weight: 600;
                ">${siteCode} - SITE IS OVER 1P DAMAGED THRESHOLD! - COMMENT: ASSIGNING URGENT DUE TO 1P THRESHOLD, GUIDED BY LEADERSHIP.</p>
                <p style="
                    margin: 0;
                    color: #555;
                    font-size: 14px;
