...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['ACY9', 'ATL2', 'BDU5', 'BNA5', 'CLE2', 'CLE3', 'DCA1', 'DEN5', 'DSM9', 'HGR5', 'HGR6', 'IGQ9', 'MSP8', 'RIC4', 'TUS5', 'XLA3', 'XLX7', 'XMD2', 'YEG2', 'DCAA'],
        urgentPrefixes: [],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
        ...
        notification.innerHTML = `
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 15px; font-weight: 600; margin-bottom: 4px;">${siteCode} - 1P THRESHOLD SITE- IF ISSUE IS: TIRE, ELECTRICAL(LIGHTS, 7-WAY), OR MUDFLAP WHEN ASSIGNING, MAKE WORK ORDER URGENT. LEAVE COMMENT: SITE IS OVER 1P DAMAGED THRESHOLD, ASSIGNING URGENT. GUIDED BY LEADERSHIP.</div>
