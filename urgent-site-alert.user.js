...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['AUS2', 'HGR6', 'ONT5', 'TEB9', 'FTW5', 'SBD6', 'BWI4', 'JFK8', 'MQJ9', 'ACY9', 'BOS3', 'BDU5', 'PDX9', 'TYS1', 'HGR2', 'HLO3', 'TUS5', 'MDT9', 'RIC4', 'HIA1', 'BNA7', 'HSE1', 'XMD2', 'HMW1', 'BOI2', 'ATL2', 'SAT3', 'MDW7', 'MDT4', 'IGQ1', 'BWI5', 'PNE5', 'ILG1', 'MCI5', 'XNJ3', 'STL8', 'XCE1', 'YOO1', 'HMW3'],
        urgentPrefixes: [],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
