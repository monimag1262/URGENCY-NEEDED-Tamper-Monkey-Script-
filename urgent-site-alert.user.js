...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['PNE5', 'MSP8', 'RDU1', 'TUS5', 'ACY9', 'MSP7', 'ATL2', 'BDU5', 'BWI5', 'AZA5', 'LAS5', 'BOI2', 'IGQ9', 'BWI4', 'ATLB', 'PSP3', 'CLT6', 'ONT5', 'ORD9', 'MDT4', 'JAX3', 'XMD2', 'SAT3', 'HGR5', 'TEB9', 'ACY1', 'DEN3', 'MDT9', 'JFK8', 'AUS5', 'MCC1', 'RFD4', 'XCE1', 'FSD1', 'CLE2', 'DEN5', 'TUL2', 'XLX7', 'HGR6', 'TYS1', 'RNT9', 'ORF5', 'SCK1'],
        urgentPrefixes: [],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
        ...
        notification.innerHTML = `
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 15px; font-weight: 600; margin-bottom: 4px;">${siteCode} - 1P THRESHOLD SITE- IF ISSUE IS: TIRE, ELECTRICAL(LIGHTS, 7-WAY), OR MUDFLAP WHEN ASSIGNING, MAKE WORK ORDER URGENT. LEAVE COMMENT: GUIDED BY LEADERSHIP TO ASSIGN URGENT IF ISSUE IS A MINOR REPAIR.</div>
