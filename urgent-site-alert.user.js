...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['ACY9', 'BDL4', 'ATL2', 'AZA5', 'BDU5', 'BWI4', 'BWI5', 'CLT6', 'DCA1', 'DEN3', 'HGR5', 'LBB5', 'MCI9', 'MDW5', 'MSP8', 'RIC4', 'TLH2', 'TUS5', 'XLX7', 'XMD2'],
        urgentPrefixes: [],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
        ...
        notification.innerHTML = `
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 15px; font-weight: 600; margin-bottom: 4px;">${siteCode} - 1P THRESHOLD SITE- IF TRAILER ISSUE IS: TIRE, ELECTRICAL(LIGHTS, 7-WAY), OR MUDFLAP WHEN ASSIGNING, MAKE WORK ORDER URGENT. LEAVE COMMENT: GUIDED BY LEADERSHIP TO ASSIGN URGENT IF ISSUE IS A MINOR REPAIR.  // @AUTHOR       MONIMAG</div>
