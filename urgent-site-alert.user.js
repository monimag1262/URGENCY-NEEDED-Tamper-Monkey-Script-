...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['ACY9', 'AUS2', 'AZA5', 'BOI2', 'BWI4', 'BWI5', 'DCA1', 'FTW5', 'GEU3', 'HGR2', 'HGR6', 'HOU9', 'HSE1', 'JFK8', 'MCI3', 'MDT4', 'ONT5', 'ORH3', 'PDX9', 'PNE5', 'RDU1', 'RIC4', 'SAT3', 'SBD6', 'SDF8', 'STL8', 'TEB9', 'TUS5', 'TYS1'],
        urgentPrefixes: [],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
