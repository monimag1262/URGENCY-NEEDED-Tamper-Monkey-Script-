...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['ACY9', 'HNE1', 'STL5', 'RIC9', 'MQJ1'],
        urgentPrefixes: ['BFI', 'MCO'],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
    };
        ...
        notification.innerHTML = `
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 15px; font-weight: 600; margin-bottom: 4px;">${siteCode} - MARY LIKES TO COLLECT CATS</div>
