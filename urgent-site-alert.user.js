...
(function() {
    ...
    const CONFIG = {
        urgentSites: ['ACY9', 'AKC1', 'ATL2', 'AUS5', 'AZA5', 'BOI2', 'BWI4', 'DEN3', 'HSE1', 'IGQ9', 'MDT4', 'MDW5', 'OKC1', 'ONT5', 'PNE5', 'RDU1', 'SAT1', 'SAT3', 'SDF8', 'TLH2', 'TUS5', 'TYS1', 'XMD2'],
        urgentPrefixes: [],
        checkInterval: 500,
        maxRetries: 20,
        debug: true
        ...
        notification.innerHTML = `
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 15px; font-weight: 600; margin-bottom: 4px;">${siteCode} - IF TRAILER ISSUE IS: TIRE, ELECTRICAL(LIGHTS, 7-WAY), OR MUDFLAP WHEN ASSIGNING, MAKE WORK ORDER URGENT. LEAVE COMMENT: GUIDED BY LEADERSHIP TO ASSIGN URGENT IF ISSUE IS A MINOR REPAIR.</div>
